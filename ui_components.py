    ...
    if not is_on:
        ...
        if st.session_state.get(confirm_key, False):
            ...
            if c1.button("Ja, Aus", key=f"yes_off_{key_prefix}_{switch_id}", type="primary", use_container_width=True):
                ...
                return True # Führt Aktion in app.py aus
